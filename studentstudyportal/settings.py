...
DATABASES = {
    'default': 
      dj_database_url.parse(os.environ.get('postgresql://studentportaldb_user:BD80yvmlYEUiIDbOcmtLMiBrnWaq770j@dpg-d1dui7fgi27c73erbk50-a.oregon-postgres.render.com/studentportaldb',))
